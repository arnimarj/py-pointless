...
FLAGS="-Wall -D_REENTRANT -D_GNU_SOURCE -fsanitize-trap -fsanitize=address -fsanitize-address-use-after-scope -fsanitize-address-use-after-return=always -O1 -fno-omit-frame-pointer"
SOURCE="../src/*.c ./c_api/*.c  ../judy-1.0.5/src/libJudy.a"

LDFLAGS="-lpthread -ldl -shared-libasan"
#-liconv"
